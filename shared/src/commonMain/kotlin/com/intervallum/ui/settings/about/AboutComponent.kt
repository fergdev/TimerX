...
import com.intervallum.ui.settings.about.main.AboutMainComponent
import com.intervallum.ui.settings.about.main.DefaultAboutMainComponent
    ...
    constructor(componentContext: ComponentContext, back: () -> Unit) : this(
        ...
        aboutMainComponentFactory = { childContext, onBack ->
            DefaultAboutMainComponent(
                ...
                onBack = onBack,
                intervallumSettings = KoinPlatform.getKoin().get(),
