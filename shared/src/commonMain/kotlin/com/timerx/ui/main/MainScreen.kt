...
internal fun MainScreen(
    ...
    Column(modifier = Modifier.safeDrawingPadding()) {
        Scaffold(
            ...
            if (state.showPermissionsMessage) {
                ModalBottomSheet(onDismissRequest = {
                    ...
                    Column(
                        ...
                        Text(text = "Please enable notification permissions for the best experience.")
                        Button(onClick = { viewModel.interactions.requestNotificationsPermission() }) {
                            Text("Enable")
                        }
                    }
                }
